Json web signature 의 약자로 [[claim]]의 내용은 누구나 읽을 수 있지만 signature가 있지 때문에, 데이터의 무결성이 보장된다. 
